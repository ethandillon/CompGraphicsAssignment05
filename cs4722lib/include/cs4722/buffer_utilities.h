...
namespace cs4722 {
  ...
  */
    GLuint initBuffers( GLuint program, std::vector<cs4722::Artifact*>& part_list,
                         const char* position_var, const char* color_var = "",
                         const char* texture_var = "", const char* normal_var = "",
                         const char* tangent_var = "");

    /**
     *  This version of initBuffers operates just like the other except that it takes a single
     *  artifact instead of a list.
     */
    GLuint initBuffers( GLuint program, cs4722::Artifact* artifact,
                        const char* position_var, const char* color_var = "",
                        const char* texture_var = "", const char* normal_var = "",
                        const char* tangent_var = "");

    // GLuint createVAO();
    // void initPositionBuffer(GLuint program, std::vector<cs4722::Artifact*>& artifact_list, const char* position_var);
    // void initColorBuffer(GLuint program, std::vector<cs4722::Artifact*>& artifact_list, const char* color_var);
