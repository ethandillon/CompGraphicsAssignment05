...
//      *
//      */
//     class ArtifactEllipticalOrbit : public cs4722::ArtifactRotating {
//
//     public:
...
//          */
//         glm::vec3 aphelionVector = glm::vec3(1,0,0);
...
//          *  `aphelion_vector` should be perpendicular to `perihelion_vector`.
//          */
//         glm::vec3 perihelionVector = glm::vec3(0, 0, 1);
//
...
//          *
//          */
//         glm::vec3 pathCenter = glm::vec3(0,0,0);
//
...
//          *
//          */
//         double orbitalRate = 0.0;  // radians per second
//
