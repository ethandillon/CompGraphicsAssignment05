...
* Do not change attributes of the `shape` after this
	...
	public:
        ...
        /**
           \brief Scale factor for texture coordinates..
        ...
        */
		 ...
		 */
		virtual std::vector<glm::vec4>* getPositions() = 0;
		 ...
		 */
		virtual std::vector<cs4722::Color>* getColors() = 0;
		 ...
		 * @return a list of colors for each vertex.
		 */
		std::vector<cs4722::Color>* getMixedColors();
         ...
         * @return
         */
		virtual std::vector<glm::vec4>* getTangents();
		 ...
		 */
		virtual std::vector<glm::vec2>* getTextureCoordinates() = 0;
...
//        double textureScale = 1.0;
		...
		std::vector<glm::vec4>* getPositions() override;
		 ...
		 *
		 */
		std::vector<cs4722::Color>* getColors() override;

		std::vector<glm::vec2>* getTextureCoordinates() override;

		std::vector<glm::vec4>* getNormals() override;

		std::vector<glm::vec4>* getTangents() override;
	...
	public:
	     ...
	     *
	     * @param topToBottomRatio  Must be non-negative
	     * @param sides Must be at least 3
	     */
		Cylinder(float topToBottomRatio, int sides);
	...
	public:
	     ...
	     *
	     *
	     * @param innerRadius should be non-negative and less than 1.
	     ...
	     *  Must be at least 3.
	     */
		Torus(float innerRadius, int bands, int sides);
	...
	public: 
		...
		Rectangle(int width, int height) :
			...
			colorSet = std::vector<Color>({ X11::olive_drab1, X11::dark_goldenrod4, });
		}
...
//    double max_height, min_height;
    ...
    public:
         ...
         */
        virtual std::vector<cs4722::Color>* getColors();
...
//        }
         ...
         * \brief Not implemented
         */
        virtual std::vector<glm::vec2>* getTextureCoordinates() {
 ...
 *      as a color scheme.
 */
    class TerrainAltColors : public Terrain {
    public:

        TerrainAltColors(HeightField *heightField) : Terrain(heightField) {}
