...
namespace cs4722 {
     ...
     */
    GLFWwindow *setupWindow(const char *title, double screen_ratio, double aspect_ratio);
    ...
    inline GLFWwindow *setup_window_9_16_9(const char *title) {
        return setupWindow(title, 0.9, 16.0 / 9.0);
    }
    ...
    inline GLFWwindow *setup_window_9_1_1(const char *title) {
        return setupWindow(title, 0.9, 1.0);
    }
     ...
     */
    double getAspectRatio(GLFWwindow *window);
